...
config.model = edict()
config.model.result_path = "debug/samples"
config.model.checkpoint_path = "debug/checkpoint"
config.model.log_path = "debug/log"
config.model.scale = 4
config.model.resblock_depth  = 10
config.model.recursive_depth = 1

config.valid = edict()
config.valid.hr_folder_path = '/public/qianyue/LapSRN/dataset/DIV2K_valid_HR/'
config.valid.lr_folder_path = '/public/qianyue/LapSRN/dataset/DIV2K_valid_LR_bicubic/X4/'

config.train = edict()
config.train.hr_folder_path = '/public/qianyue/LapSRN/dataset/DIV2K_train_HR/'
config.train.lr_folder_path = '/public/qianyue/LapSRN/dataset/DIV2K_train_LR_bicubic/X4/'
